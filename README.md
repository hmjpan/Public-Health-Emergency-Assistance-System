...
| 账号 | 角色 | 用途 |
|------|------|------|
| commander | 指挥长 | 研判、一键启动、推进阶段、审批发布 |
| deputy | 副指挥 | 同指挥长 |
| liudiao | 流调组长 | 确认出动、激活任务、填报表单 |
| medic | 医疗救治员 | 病例登记、密接追踪、资源更新 |
| wuzi | 物资管理员 | 备货、装车、标记紧缺 |
| siji | 驾驶员 | 车辆就位、电子通行证 |
| spokesman | 宣教发言人 | 起草发布稿、舆情录入 |
| reviewer | 复盘评估员 | 发起复盘、整改闭环 |
| info | 信息员 | 一线上报 |
| member | 队员 | 接收任务、确认通知 |
| admin | 平台管理员 | 账号管理 |
| drill | 演练管理员 | 模拟演练管理 |
